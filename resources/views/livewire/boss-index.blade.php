        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <div>
                <div class="flex items-center gap-x-3">
                    <h2 class="text-lg font-medium text-gray-800 ">Firmar como Jefe de Oficina</h2>
                        ...
                        <table class="min-w-full divide-y divide-gray-200 ">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 ">
                                ...
                                <tr id="pass_ids{{ $pass->id }}" >
                                    ...
                                    <td class="px-4 py-4 text-sm font-medium max-w-10 overflow-auto break-words">
                                        <div>
                                    ...
                                    <td class="px-4 py-4 text-sm p-1 ">
                                        ...
                                        @if($pass->estado==1)
                                            <div class="w-full h-full place-content-around flex  flex-col md:flex-row  justify-center items-center align-middle">
                                                <a href="{{ route('passes.firmarboss', $pass) }}"
                                                     class="mx-1" title="Firmar" onclick="mostrarConfirmacion(event, '{{ route('passes.firmarboss', $pass) }}')">
                                                     <button class="bg-blue-600 text-white text-xs rounded px-2 py-2 flex items-center" title="Rechazar">
                                        ...
                                        @else
                                            <div class="w-full h-full place-content-around flex  flex-col md:flex-row  justify-center items-center align-middle">
                                                <a
                                                    class="bg-gray-400 text-white rounded px-2 py-1 mx-1 flex items-center" title="Firmar">
