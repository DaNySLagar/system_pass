    ...
    <div class="container">
        ...
        <div >
            ...
            <div class="label" >{{ $pass->id }}</div><br><br>
                ...
                @if (isset($pass->return_time->hour_return ))
                ...
                <label style="font-weight: bold;">OBSERVACIONES:</label><br>
                @if (isset($pass->return_time->observation ))
                <br><div class="underline_obs">{{ $pass->return_time->observation }}</div>
                @else
                <br><div class="underline_obs">Sin Observaciones</div>
                @endif
                <br><br>
                ...
                <div class="info" style="text-align: center;">
                    <div class="underline">Restringido (personal) </div><br>     
