...
class ArchivedController extends Controller
{
    ...
    public function show(Request $request, Pass $pass){
        ...
        $departure = Departure_time::where('pass_id', '=', $request->id)->get();
        $return = Return_time::where('pass_id', '=', $request->id)->get();
        
        
        return view('archived.show', compact('pass', 'departure', 'return'));
    }
