        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <div>
                <div class="flex items-center gap-x-3">
                    <h2 class="text-lg font-medium text-gray-800 ">Firmar como Jefe de Recursos Humanos</h2>
            ...
            {{-- <div class="flex items-center mt-4 gap-x-3">
                ...
                <button class="flex items-center justify-center w-1/2 px-5 py-2 text-sm text-gray-700 transition-colors duration-200 bg-white border rounded-lg gap-x-2 sm:w-auto   hover:bg-gray-10 ">
                    ...
                    <div class="overflow-hidden border border-gray-200  md:rounded-lg">
                        <table class="min-w-full divide-y divide-gray-200 ">
                            <thead class="bg-gray-50 ">
                                <tr>
                                    <th scope="col" class="px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-500 ">Codigo</th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200  ">
                                ...
                                <tr id="pass_ids{{ $pass->id }}" >
                                    <td class="px-4 py-4 text-sm whitespace-nowrap">
                                        <div>
                                            <p class="text-sm font-normal text-gray-600 ">{{ $pass->id }}</p>
                                        </div>
                                    </td>
                                    {{-- <td class="px-2 py-4 text-sm font-medium whitespace-nowrap">
                                        ...
                                        <div class="flex justify-center items-center">
                                            ...
                                            @elseif($pass->estado != 5 && $pass->estado != 2)
                                    ...
                                    <td class="px-4 py-4 text-sm whitespace-nowrap">
                                        <div class="max-w-xs overflow-auto max-w-10"> <!-- Agregamos la clase max-w-10 para limitar el ancho -->
                                            <h4 class="text-gray-70">{{ $pass->place }}</h4>
                                    ...
                                    <td class="px-4 py-4 text-sm p-1 ">

                                      
                        @if($pass->estado==2)
                        <div class="w-full h-full place-content-around flex  flex-col md:flex-row  justify-center items-center align-middle">
                            <a href="{{ route('passes.firmarrh', $pass) }}"
                            class="bg-sky-900 text-white rounded px-2 py-1 mx-1 flex items-center" title="Firmar" onclick="mostrarConfirmacion(event, '{{ route('passes.firmarrh', $pass) }}')">
                        ...
                        FIRMAR
                            ...
                            @livewire('decline-modal', ['id' => $pass->id, 'user' => 1], key('show-modal-' . $pass->id))
                            
                        </div>
                    @else
                    <div class="w-full h-full place-content-around flex  flex-col md:flex-row  justify-center items-center align-middle">
                            <a
                                class="flex items-center bg-gray-400 text-white rounded px-2 py-1 mx-1" title="Firmar">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                class="w-4 h-4 mx-2 ">
                                <path fill-rule="evenodd"
                                    d="M12 3.75a6.715 6.715 0 00-3.722 1.118.75.75 0 11-.828-1.25 8.25 8.25 0 0112.8 6.883c0 3.014-.574 5.897-1.62 8.543a.75.75 0 01-1.395-.551A21.69 21.69 0 0018.75 10.5 6.75 6.75 0 0012 3.75zM6.157 5.739a.75.75 0 01.21 1.04A6.715 6.715 0 005.25 10.5c0 1.613-.463 3.12-1.265 4.393a.75.75 0 01-1.27-.8A6.715 6.715 0 003.75 10.5c0-1.68.503-3.246 1.367-4.55a.75.75 0 011.04-.211zM12 7.5a3 3 0 00-3 3c0 3.1-1.176 5.927-3.105 8.056a.75.75 0 11-1.112-1.008A10.459 10.459 0 007.5 10.5a4.5 4.5 0 119 0c0 .547-.022 1.09-.067 1.626a.75.75 0 01-1.495-.123c.041-.495.062-.996.062-1.503a3 3 0 00-3-3zm0 2.25a.75.75 0 01.75.75A15.69 15.69 0 018.97 20.738a.75.75 0 01-1.14-.975A14.19 14.19 0 0011.25 10.5a.75.75 0 01.75-.75zm3.239 5.183a.75.75 0 01.515.927 19.415 19.415 0 01-2.585 5.544.75.75 0 11-1.243-.84 17.912 17.912 0 002.386-5.116.75.75 0 01.927-.515z"
